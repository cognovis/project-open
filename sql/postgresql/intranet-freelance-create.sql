...
'registered_users u2 LEFT JOIN im_freelancers f USING (user_id)','u.user_id = u2.user_id',0,'');
...
delete from im_categories where category_id >= 6000 and category_id <= 6006;
...
delete from im_categories where category_id >= 6100 and category_id <= 6104;
