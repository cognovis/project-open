...
create function workflow__create_workflow (varchar,varchar,varchar,varchar,varchar,varchar)
returns varchar as '
declare
...
create function workflow__drop_workflow (varchar)
returns integer as '
declare
...
create function workflow__delete_cases (varchar)
returns integer as '
declare
...
create function workflow__create_attribute (varchar,varchar,varchar,varchar,varchar,varchar,varchar,varchar,integer,integer,integer,varchar)
returns integer as '
declare
...
create function workflow__drop_attribute (varchar,varchar)
returns integer as '
declare
...
-- procedure add_place
create function workflow__add_place (varchar,varchar,varchar,integer)
returns integer as '
declare
...
create function workflow__delete_place (varchar,varchar)
returns integer as '
declare
...
-- procedure add_role
create function workflow__add_role (varchar,varchar,varchar,integer)
returns integer as '
declare
...
create function workflow__move_role_up (varchar,varchar)
returns integer as '
declare
...
create function workflow__move_role_down (varchar,varchar)
returns integer as '
declare
...
create function workflow__delete_role (varchar,varchar)
returns integer as '
declare
...
create function workflow__add_transition (varchar,varchar,varchar,varchar,integer,varchar)
returns integer as '
declare
...
create function workflow__delete_transition (varchar,varchar)
returns integer as '
declare
...
-- procedure add_arc
create function workflow__add_arc (varchar,varchar,varchar,varchar,varchar,varchar,varchar)
returns integer as '
declare
...
-- procedure add_arc
create function workflow__add_arc (varchar,varchar,varchar,varchar,varchar,varchar)
returns integer as '
declare
  add_arc__workflow_key		alias for $1;
...
-- procedure add_arc
create function workflow__add_arc (varchar,varchar,varchar)
returns integer as '
declare
  add_arc__workflow_key		alias for $1;
...
create function workflow__delete_arc (varchar,varchar,varchar,varchar)
returns integer as '
declare
...
-- procedure add_trans_attribute_map
create function workflow__add_trans_attribute_map (varchar,varchar,varchar,integer)
returns integer as '
declare
  p_workflow_key		alias for $1;
  p_transition_key		alias for $2;
...
create function workflow__delete_trans_attribute_map (varchar,varchar,integer)
returns integer as '
declare
  p_workflow_key		alias for $1;
  p_transition_key		alias for $2;
...
-- procedure delete_trans_attribute_map
create function workflow__delete_trans_attribute_map (varchar,varchar,varchar)
returns integer as '
declare
  p_workflow_key		alias for $1;
  p_transition_key		alias for $2;
...
create function workflow__add_trans_role_assign_map (varchar,varchar,varchar)
returns integer as '
declare
  p_workflow_key		alias for $1;
  p_transition_key		alias for $2;
...
create function workflow__delete_trans_role_assign_map (varchar,varchar,varchar)
returns integer as '
declare
  p_workflow_key		alias for $1;
  p_transition_key		alias for $2;
...
create function workflow__simple_p (varchar)
returns boolean as '
declare
...
create function __workflow__simple_p (varchar,integer)
returns boolean as '
declare
  simple_p__workflow_key           alias for $1;  
