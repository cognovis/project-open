...
-- width=21 height=22 border=0 ALT=\"[_ intranet-core.MSN_Status]\"></A>"','','',5,'');
...
insert into im_view_columns (column_id, view_id, group_id, column_name, column_render_tcl,
extra_select, extra_where, sort_order, visible_for) values (8190,81,NULL,' ','"<input type=\"submit\" value=\"[_ intranet-core.Edit]\">"','','',
900,'set a $admin');
