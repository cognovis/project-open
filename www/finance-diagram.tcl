...
"]
lappend left_scale_plain [list $sigma $sigma $sigma $sigma $sigma $sigma]
...
template::multirow create sums x1 y1
...
foreach left_entry $left_scale_plain {
    ...
    set top_entry [ lindex $top_scale [expr [llength $top_scale ]-1] ]
	...
	ns_write "* $left_entry $val<br>\n"

        
	template::multirow append sums $key $val
}
}
ns_write {<SCRIPT Language="JavaScript" src="/resources/diagram/diagram/diagram.js"></SCRIPT> }
...
ns_write [template::diagram::render -name dia1]
