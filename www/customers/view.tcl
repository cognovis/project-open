# /packages/intranet-core/www/intranet/customers/view.tcl
#
...
set price_list_html ""
if {[db_table_exists im_trans_prices] && [im_permission $user_id view_invoices]} {

    set price_list_html "
<table border=0>
  <tr> 
    <td colspan=6 class=rowtitle align=center>Price List</td>
  </tr>
  <tr class=rowtitle> 
...
"
	...
	append price_list_html "<tr><td colspan=4 align=center><B>No prices found</B></td></tr>\n"
    }

    append price_list_html "\n</table>\n"

    append price_list_html "<ul>\n"
    append price_list_html "<li><a href=upload-prices?[export_url_vars customer_id return_url]>Upload Prices</A>"
    append price_list_html "</ul>\n"
}
