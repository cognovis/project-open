# /packages/intranet-reporting/www/finance-documents-projects.tcl
#
...
set this_url [export_vars -base "/intranet-reporting/finance-documents-projects" {start_date end_date} ]
...
ns_log Notice "intranet-reporting/finance-documents-projects: sql=\n$sql"
