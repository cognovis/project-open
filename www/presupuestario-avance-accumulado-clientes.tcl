...
set page_title [lang::message::lookup "" intranet-reporting-openoffice.Informe_Presupuestario_y_de_Avance_Clientes "Informe Presupuestario y de Avance Clientes"]
