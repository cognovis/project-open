...
set search_title  [lang::message::lookup "" intranet-mail-import.Title_Search "Bulk assignement"]
...
set hint_search [lang::message::lookup "" intranet-mail-import.Hint_Type_And_Find "Search for users or projects requires a minimum of 4 chars."]
