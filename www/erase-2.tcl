# /packages/intranet-filestorage/www/erase-2.tcl
#
...
ad_page_contract {
    ...
    @cvs-id frank.bergmann@project-open.com
} {
    file_name:notnull
    {folder_type ""}
    { id_file:array}
...
set return_url [im_url_with_query]
   	...
   	foreach {clau valor} [array get id_file] {
		...
		if { [string compare $file_type "directory"] == 0 } {    	
			set erase [im_filestorage_delete_folder $group_id $valor]
    		} else {
    			set erase [im_filestorage_erase_files $group_id $valor] 	
   		}
