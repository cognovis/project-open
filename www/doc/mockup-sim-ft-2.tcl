...
set page_title "Editing 'First Lawyer's Task'"
...
multirow append states "Active" "<input type=\"checkbox\" checked=1>"
multirow append states "Complete" "<input type=\"checkbox\">"
