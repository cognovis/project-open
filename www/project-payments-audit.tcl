...
set context_bar [ad_context_bar [list "[im_url_stub]/projects/" "<#_ Projects#>"] [list "[im_url_stub]/projects/view?[export_url_vars group_id]" $project_name] [list index?[export_url_vars group_id] "<#_ Payments#>"] "<#_ Audit trail#>"]
