...
set context_bar [ad_context_bar [list "[im_url_stub]/projects/" "Projects"] [list "[im_url_stub]/projects/view?[export_url_vars group_id]" $project_name] [list index?[export_url_vars group_id] "Payments"] "Audit trail"]
