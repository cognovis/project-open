...
<table width="95%" border="0" cellpadding="1" cellspacing="1">
  <tr>
    <td>&nbsp; </td>
       <td align="right" valign="bottom"> <img src="/logo.jpg">
          <br>
      </td>
 </tr>
</table>
...
<tr>
        <td class="rowtitle"><%= [lang::message::lookup $locale intranet-core.Project_Type "Project type"] %>:&nbsp;</td>
        <td class="address"><%=$project_type_pretty %></td>
</tr>
</table>
<p>
