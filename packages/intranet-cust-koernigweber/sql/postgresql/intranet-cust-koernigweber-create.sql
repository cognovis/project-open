...
-- -----------------------------------
-- DynField for Comments for Absences 
-- -----------------------------------
...
begin
        ...
        SELECT INTO v_dynfield_id SELECT im_dynfield_attribute_new (''im_user_absence'', 'comments'', 'Comments'', 'varchar'', ''textbox_medium '', ''f'');
