...
db_foreach sql $sql {
        ...
        # Ocerwrite billing rate with WEBER Price List
    	set billing_rate [find_sales_price $user_id $project_id $company_id "" $date_pretty]
	if { "" == $billing_rate  } { set billing_rate "--,--"}
