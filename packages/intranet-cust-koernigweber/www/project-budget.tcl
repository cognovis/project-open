# /packages/intranet-cust-koerngweber/www/project-budget.tcl
#
...
set result [ad_parse_template -params $params "/packages/intranet-cust-koernigweber/lib/project-budget"]
