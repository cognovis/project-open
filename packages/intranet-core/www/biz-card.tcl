...
set title "[_ intranet-core.Add_a_Biz_Card]"
...
if {"" != $button_new_user_company} {
    ad_returnredirect [export_vars -base "/intranet/biz-card-3.tcl" {first_names last_name email company_name profile}]
}
...
#	append company_html "&nbsp;<br>"
    ...
    ns_log Notice "biz-card.tcl: Before executing db_multirow"
    ...
    ns_log Notice "biz-card.tcl: After executing db_multirow"
