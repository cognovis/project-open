...
{...}
    ...
    ns_log Debug "new: ad_form: before template::form is_submission"

    if { [template::form is_submission $form_name] } {

	ns_log Debug "new: ad_form: is_submission:"

        if { [uplevel #$level {set __refreshing_p}] } {

	    ns_log Debug "new: ad_form: refreshing:"
		...
		ns_log Debug "new: ad_form: valid:"
		    ...
		    ns_log Debug "new: ad_form: confirmed:"
		...
		ns_log Debug "new: ad_form: before three ways"
		...
		ns_log Debug "new: ad_form: before new or edit"
