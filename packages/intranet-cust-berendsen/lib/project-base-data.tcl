...
set dynfield_ids [$project dynfield_ids]

ds_comment "dynfields:: $dynfield_ids"
...
#    }
    ...
    # Make sure to set the variables as well
    set [$element attribute_name] $value
}


# Hack for only allowing MPKs to edit projects
set write 1
if {$project_status_id eq 10000006 || [im_profile::member_p -user_id $current_user_id -profile "MPK"]} {
    set write 1
}