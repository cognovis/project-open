...
set page_url "/intranet-pmo/resources-planning"
set sub_navbar ""
...
if {"" == $end_date} { set end_date [db_string get_previous_month "SELECT '$start_date'::date+'1 day'::interval-'1 day'::interval" -default 0] }
