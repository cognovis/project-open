...
ad_form -name confirm_delete -export {item_id} -form {
   {confirmation:text(radio) {label "[_ monitoring.Delete]"}
	...
	if {$confirmation} {
	    #db_transaction {
	        db_dml do_delete   "delete from ad_monitoring_tables_estimated"  
	        db_dml do_delete1  "delete from ad_monitoring_top_proc"  
		db_dml do_delete2  "delete from ad_monitoring_top" 
            #} on_error {
