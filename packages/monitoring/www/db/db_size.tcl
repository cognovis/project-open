...
set db_size_current [expr [db_string size_current "select db_size from ad_monitoring_db where db_id = :end_db_id "] / 1024 ]

set db_size_current_kb [ad_monitor_format_kb $db_size_current]
