# packages/intranet-xo-dynfield/tcl/02-element-procs.tcl
#
...
::im::dynfield::Element ad_instproc save {} {
    ...
    db_dml up_im_dynfield_att "update im_dynfield_attributes set include_in_search_p = :include_in_search_p, also_hard_coded_p = :also_hard_coded_p, deprecated_p = :deprecated_p, widget_name = :widget_name, widget = :widget where attribute_id = :dynfield_attribute_id"
