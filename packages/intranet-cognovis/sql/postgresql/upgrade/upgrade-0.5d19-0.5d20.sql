-- 
-- packages/intranet-cognovis/sql/postgresql/upgrade/upgrade-0.5d19-0.5d20.sql
-- 
...
SELECT acs_log__debug('/packages/intranet-cognovis/sql/postgresql/upgrade/upgrade-0.5d19-0.5d20.sql','');
...
BEGIN
	...
	select	ot.object_type, ot.supertype, ot.status_type_table, ot.id_column, ot.status_column
