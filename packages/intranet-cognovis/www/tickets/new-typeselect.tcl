...
# ad_return_complaint 1 "sla=$parent_id, type=$ticket_type_id"
...
set sql "
	select
		...
		p.parent_id as category_parent_id
	from
		im_categories c
...
db_foreach cats $sql {
    ...
    if {$old_parent_id != $category_parent_id} {
	append category_select_html "<tr><td colspan=2><b>[im_category_from_id $category_parent_id]</b><br></td></tr>\n"
	set old_parent_id $category_parent_id
    }
