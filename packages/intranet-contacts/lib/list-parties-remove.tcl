ad_page_contract {
    ...
    @cvs-id $Id: list-parties-remove.tcl,v 1.1 2009/02/08 22:28:17 cvs Exp $
} {
...
set title "[_ intranet-contacts.Remove_from_List]"
...
append form_elements {
    {list_ids:text(checkbox),multiple {label "[_ intranet-contacts.Remove_from_Lists]"} {options $list_options}}
}
set edit_buttons [list [list "[_ intranet-contacts.lt_Remove_from_selected_Lists]" create]]
