...
set root_folder_p 0
set root_folder_id [intranet_fs::get_project_folder_id -project_id $project_id]
...
if {[info exists project_id]} {
    ...
    set project_name [db_exec_plsql select_project_name " SELECT im_name_from_id($project_id) "]
}

set up_url {}
if { !${root_folder_p}} {
    
    db_1row select_parent_folder_id {
	SELECT parent_id AS parent_folder_id FROM cr_items WHERE item_id = :folder_id
    }    
