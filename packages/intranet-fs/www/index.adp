...
<if @up_url@ not nil or  @project_url@ not nil>
	<div class="list-button-bar-top">
		...
		<if @project_url@ not nil>
			<a href="@project_url@" class="button">#file-storage.back_to_project#: @project_name@</a>
		</if>

	</div>
</if>
<include src="/packages/intranet-fs/lib/folder-chunk" folder_id="@folder_id@"
    n_past_days="@n_past_days@" allow_bulk_actions="1" return_url="@return_url@" category_id="@category_id@" project_id="@project_id@">
