...
if {[exists_and_not_null cost_id]} {
    set page_title "[_ intranet-budget.Edit_Provider_Estimation]"
} else {
    set page_title "[_ intranet-budget.New_Provider_Estimation]"
}

set sub_navbar [im_costs_navbar "none" "/intranet-cost/" "" "" [list]] 
