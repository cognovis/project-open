...
ad_return_top_of_page "
  ...
  &nbsp;<h2>Timesheet : [lindex $monthnames [expr [lindex $datesplit 0] - 1]] [lindex $datesplit 1] &nbsp&nbsp&nbsp&nbsp Nom : [im_name_from_user_id $user_id]</h2>&nbsp;
  </td></tr></table>
