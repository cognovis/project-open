...
/*
 * Business Process Definition: Feature Request (feature_request_wf)
 *
 ...
 * Cases table
 */
create table feature_request_wf_cases (
...
begin
    PERFORM workflow__create_workflow (
        ...
        ''Feature Request'', 
        ''Feature Request'', 
        ''A customer''''s feature request is answered by a quote. After a confirm, the task is assigned, executed and submitted to sign-off. '', 
        ''feature_request_wf_cases'',
        ''case_id''
    );
...
('default',
 ...
 1,
 'Assign',
 '/packages/intranet-helpdesk/www/new',
 'f',
 'f',
 'f');
