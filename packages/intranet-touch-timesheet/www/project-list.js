...
Ext.application({
	...
	var projectStore = Ext.create('Ext.data.Store', {
        ...
        return {
            ...
            itemTpl: '<div class="contact2"><strong>{project_name}</strong></div>',
            ...
            onItemDisclosure: function(record, item, index, e) {
                //show a messagebox alert which shows the item
                e.stopEvent();
                Ext.Msg.alert('Disclose', 'Disclose more info for ' + record.get('project_name'));
            },
