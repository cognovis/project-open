...
<if @output_format@ eq "component_html">

	<!--
	Abrechenbar lt. Preismatrix -105,00 EUR
	Sonst. Kosten -  83,33 EUR
	Zulieferrechnungen -200,00 EUR
	Anspruch - 388,33 EUR (Zeile fett; ist die Summe der ersten 3 Zeilen)
	Leerzeile
	Abgerechnet 120,00 EUR
